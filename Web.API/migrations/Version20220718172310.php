...
final class Version20220718172310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE presences_channel (id INT AUTO_INCREMENT NOT NULL, guild_id INT NOT NULL, association_id INT NOT NULL, channel_id VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_44D0625772F5A1AA (channel_id), UNIQUE KEY presences_unique_key (guild_id, association_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
